<%@ Page Title="" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="Department.aspx.vb" Inherits="Department" %>
...
<tr class="tdcolbg">
	...
	<tr class="whitebg">
		<td align="right" style="width:50%;" class="tdtext">Department Code :</td>
		<td style="width:50%;" class="tdtext">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                Display="None" ErrorMessage="Enter Dept Code" SetFocusOnError="True" 
                ValidationGroup="category"  ControlToValidate="txtcategorycode"></asp:RequiredFieldValidator>
        </td>
	</tr>
    <tr class="whitebg">
		<td align="right" class="tdtext">Department Name :</td>
		<td class="tdtext"><asp:TextBox ID="txtcategorydesc" runat="server" Width="300px" 
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                ErrorMessage="Enter Dept Name" SetFocusOnError="True" 
	...
	<tr>
		...
		<tr class="">
		    ...
		    <asp:DropDownList ID="drpreportsearch" runat="server" CssClass="control"> 
		         <asp:ListItem Value="deptcode">Department Code</asp:ListItem>
	...
	<tr class="">
	    ...
	    <table align="center" cellpadding="0" cellspacing="0" width="100%" style="background-color:white;">
	        <tr class="">
	            <td>
                    <asp:GridView ID="grdreportcategory" runat="server"  DataKeyNames="deptid" 
                    CssClass="mGrid"
                    GridLines="None"
                    ...
                    AutoGenerateColumns="false" Width="100%" EmptyDataText="No Data Found !">
                     <Columns>
                          ...
                          <ItemTemplate><%#Container.DataItemIndex + 1%></ItemTemplate>
                            ...
                            <asp:BoundField HeaderText="Department Name" HeaderStyle-HorizontalAlign="Center" DataField="deptcode" SortExpression="deptcode" ReadOnly="true" />
                            <asp:BoundField HeaderText="Department Code" HeaderStyle-HorizontalAlign="Center" DataField="deptname" SortExpression="deptname" />
                         ...
                         <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
                          ...
                          <ItemTemplate>
                          <asp:ImageButton ID="imgdelete" CommandName="Deleterow" CommandArgument='<%# Eval("deptid")%>' runat="server" ImageUrl="~/Images/Delete.png" OnClientClick="javascript:return confirm('Are you Sure want to Delete This Item?');"  ></asp:ImageButton>
                          </ItemTemplate>
                             </asp:TemplateField>
                        </Columns>
                    </asp:GridView>	   

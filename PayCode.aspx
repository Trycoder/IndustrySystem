<%@ Page Title="" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="PayCode.aspx.vb" Inherits="PayCode" %>
...
<tr class="tdcolbg">
	...
	<tr class="whitebg">
		<td align="right" style="width:50%;" class="tdtext">Pay Code:</td>
		<td style="width:50%;" class="tdtext">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                Display="None" ErrorMessage="Enter PayCode" SetFocusOnError="True" 
                ValidationGroup="category"  ControlToValidate="txtcategorycode"></asp:RequiredFieldValidator>
        </td>
	</tr>
    <tr class="whitebg">
		<td align="right" class="tdtext">Pay Description :</td>
		<td class="tdtext"><asp:TextBox ID="txtcategorydesc" runat="server" Width="300px" 
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                ErrorMessage="Enter Pay Description" SetFocusOnError="True" 
        ...
        <tr class="whitebg">
		<td style="width:20%;" class="tdtext" align="right">Pay Type:</td>
				<td style="width:80%;">
            <asp:DropDownList ID="CboPayType" runat="server" CssClass="control">
        ...
        <tr class="whitebg">
		<td style="width:20%;" class="tdtext" align="right">Calculation :</td>
				<td style="width:80%;">
            <asp:DropDownList ID="CboPayFormula" runat="server" CssClass="control">
                <asp:ListItem Value="1">Formula</asp:ListItem>
	...
	<tr>
		...
		<tr class="">
		    ...
		    <asp:DropDownList ID="drpreportsearch" runat="server" CssClass="control"> 
		         <asp:ListItem Value="paycode">Pay Code</asp:ListItem>
                 <asp:ListItem Value="paydesc">Pay Description</asp:ListItem>
            </asp:DropDownList></td>
		    <td class="tdtext">
	...
	<tr class="">
	    ...
	    <table align="center" cellpadding="0" cellspacing="0" width="100%" style="background-color:white;">
	        <tr class="">
	            <td>
                    <asp:GridView ID="grdreportcategory" runat="server"  DataKeyNames="paycodeid" 
                    CssClass="mGrid"
                    GridLines="None"
                    ...
                    AutoGenerateColumns="false" Width="100%" EmptyDataText="No Data Found !">
                     <Columns>
                          ...
                          <ItemTemplate><%#Container.DataItemIndex + 1%></ItemTemplate>
                            ...
                            <asp:BoundField HeaderText="Pay Code" HeaderStyle-HorizontalAlign="Center" DataField="paycode" SortExpression="paycode" ReadOnly="true" />
                            <asp:BoundField HeaderText="Pay Description" HeaderStyle-HorizontalAlign="Center" DataField="paydesc" SortExpression="paydesc" />
                            <asp:BoundField HeaderText="Pay Type" HeaderStyle-HorizontalAlign="Center" DataField="paytype" SortExpression="paytype" />
                            <asp:BoundField HeaderText="Pay Formula" HeaderStyle-HorizontalAlign="Center" DataField="payformula" SortExpression="payformula" />
                         ...
                         <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
                          ...
                          <ItemTemplate>
                          <asp:ImageButton ID="imgdelete" CommandName="Deleterow" CommandArgument='<%# Eval("paycodeid")%>' runat="server" ImageUrl="~/Images/Delete.png" OnClientClick="javascript:return confirm('Are you Sure want to Delete This Item?');"  ></asp:ImageButton>
                          </ItemTemplate>
                             </asp:TemplateField>
                        </Columns>
                    </asp:GridView>	   

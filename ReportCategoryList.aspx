<%@ Page Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="ReportCategoryList.aspx.vb" Inherits="ReportCategoryList" title="Report Category List" %>
...
<tr class="tdcolbg">
	...
	<tr class="trheaderbg">
		<td  colspan = "2">		Add Report Category
	...
	<tr class="whitebg">
		<td align="right" style="width:50%;" class="tdtext">Report Category Code :</td>
    ...
    <tr class="whitebg">
		<td align="right" class="tdtext">ReportCategory Description :</td>
	...
	<tr class="">
	    ...
	    <table align="center" cellpadding="0" cellspacing="0" width="100%" style="background-color:white;">
	        <tr class="">
	            <td>
                    <asp:GridView ID="grdreportcategory" runat="server"  DataKeyNames="id" 
                    CssClass="mGrid"
                    GridLines="None"
                    ...
                    AutoGenerateColumns="false" Width="100%" EmptyDataText="No Data Found !">
                     <Columns>
                          ...
                          <ItemTemplate><%#Container.DataItemIndex + 1%></ItemTemplate>
                            ...
                            <asp:BoundField HeaderText="Category Code" HeaderStyle-HorizontalAlign="Center" DataField="catcode" SortExpression="catcode" ReadOnly="true" />
                            <asp:BoundField HeaderText="Category Desc" HeaderStyle-HorizontalAlign="Center" DataField="catdesc" SortExpression="catdesc" />

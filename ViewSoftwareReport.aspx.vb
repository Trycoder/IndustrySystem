...
Imports System.Data
Partial Class ViewSoftwareReport
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If s.Length > 6 Then
            ...
            assettypes = s(1)
            condition = s(2)
            lblcondition.Text = s(2)
            usercondition = s(3)
            orderby = s(4)
            rights = s(5)
            reportheaders = s(6)
            reportheaderdesc = s(7)
        Else
    ...
    Protected Sub btncancel_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btncancel.Click
        Response.Redirect("SoftwareReport.aspx")
    End Sub
    'Protected Sub btnsave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnsave.Click
    '    Try
    '        Dim sql As String
    '        If assettypes = "" Then
    '            Dim myscript1 As String = "alert('Software Type are Empty! ');"
    ...
    '        sql = sql & "'" & reportheaderdesc & "','" & orderby & "','')"
    ...
    '        con.Close()
    '        sql.Trim()
    '        Response.Redirect("SoftwareReport.aspx", True)
    '    Catch ex As Exception

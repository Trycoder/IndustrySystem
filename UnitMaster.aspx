<%@ Page Title="" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="UnitMaster.aspx.vb" Inherits="UnitMaster" %>
...
<tr class="tdcolbg">
	...
	<tr class="trheaderbg">
		<td  colspan = "2">		 Unit of Measurement
	...
	<tr class="whitebg">
		<td align="right" style="width:50%;" class="tdtext">Unit Code :</td>
		<td style="width:50%;" class="tdtext">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                Display="None" ErrorMessage="Enter Unit Code" SetFocusOnError="True" 
                ValidationGroup="category"  ControlToValidate="txtcategorycode"></asp:RequiredFieldValidator>
        </td>
	</tr>
    <tr class="whitebg">
		<td align="right" class="tdtext">Unit Description :</td>
		<td class="tdtext"><asp:TextBox ID="txtcategorydesc" runat="server" Width="300px" 
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                ErrorMessage="Enter Unit Description" SetFocusOnError="True" 
	...
	<tr>
		...
		<tr class="">
		    ...
		    <asp:DropDownList ID="drpreportsearch" runat="server" CssClass="control"> 
		         <asp:ListItem Value="unitcode">Unit Code</asp:ListItem>
                 <asp:ListItem Value="unitdesc">Unit Description</asp:ListItem>
            </asp:DropDownList></td>
		    <td class="tdtext">
                    ...
                    AutoGenerateColumns="false" Width="100%" EmptyDataText="No Data Found !">
                     <Columns>
                          ...
                          <ItemTemplate><%#Container.DataItemIndex + 1%></ItemTemplate>
                            ...
                            <asp:BoundField HeaderText="Unit Code" HeaderStyle-HorizontalAlign="Center" DataField="unitcode" SortExpression="unitcode" ReadOnly="true" />
                            <asp:BoundField HeaderText="Unit Description" HeaderStyle-HorizontalAlign="Center" DataField="unitdesc" SortExpression="unitdesc" />

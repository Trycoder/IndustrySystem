...
Partial Class Status_count_details
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not String.IsNullOrEmpty(assetstatus) And Not String.IsNullOrEmpty(assettypeid) Then
            BindGrid()
        ElseIf Not String.IsNullOrEmpty(assetstatus) And String.IsNullOrEmpty(assettypeid) Then
            BindStatusGroup()
        End If
    End Sub
    ...
    Public Function BindStatusGroup()
        Try
            ...
            End If
            con.Open()
            cmd = New SqlCommand("select * from tbl_Asset_TypeMaster atm,tbl_Asset_CategoryMaster am where atm.catid = am.catid and am.groupid = 1", con)
            ...
            If rdr.HasRows Then
                ...
                While rdr.Read
                    ...
                    dtable = New DataTable
                    dtable = LoadDetailsView(GetRequiredFields(rdr("assettypeid")), assetstatus, rdr("assettypeid"))
                    If dtable.Rows.Count > 0 Then

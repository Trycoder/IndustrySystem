...
Partial Class EditAssets
    ...
    Public Function GetAssetValue(ByVal fieldname As String, ByVal assettypeid As String, ByVal fromassetno As String) As String
        Dim sql As String
        Try
            sql = "select " & fieldname & " from  tbl_Asset_Master am,tbl_Asset_Status ast where am.AssetTypeid =" & assettypeid & " and am.id = ast.Assetid and ast.status ='N' and am.id=" & fromassetno
    ...
    Public Sub LoadDetailsView(ByVal catid As String)
        ...
        sql = sql & " from tbl_Asset_Master where AssetTypeid =" & drpAssetType.SelectedValue
        cmd.Dispose()
        If con.State = ConnectionState.Open Then
            con.Close()
        End If
    ...
    End Function
    'Private Function GetCoutries() As DataTable
    '    Dim table As New DataTable("Coutries")
    '    'Add Cloumns

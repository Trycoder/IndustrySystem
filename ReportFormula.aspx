<%@ Page Language="VB" MasterPageFile="~/Master.master" ValidateRequest="false" AutoEventWireup="false" CodeFile="ReportFormula.aspx.vb" Inherits="ReportFormula" title="Add New Report" %>
...
<tr class="tdcolbg">
    ...
    <tr class="whitebg">
		<td align="right" class="tdtext">Select Asset Category :</td>		
		<td class="tdtext">
		<table>
		<tr>
		<td>
	...
	<%--	<asp:Button ID="btnviewreport"  runat="server" Text="View Report" CssClass="lButton" Width ="80px" onclick="btnviewreport_Click" />--%>
	<asp:Button ID="btnviewreport" runat="server" Text="View Report" CssClass="lButton" Width ="80px" />&nbsp;&nbsp;
	<asp:Button       ID="btnSave" runat="server" CssClass="lButton" Text="Save" 

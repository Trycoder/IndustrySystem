<%@ Page Title="" Language="VB" MasterPageFile="~/Master.master" AutoEventWireup="false" CodeFile="Designation.aspx.vb" Inherits="Designation" %>
...
<tr class="tdcolbg">
	...
	<tr class="whitebg">
		<td align="right" style="width:50%;" class="tdtext">Designation Code :</td>
		<td style="width:50%;" class="tdtext">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                Display="None" ErrorMessage="Enter Desig Code" SetFocusOnError="True" 
                ValidationGroup="category"  ControlToValidate="txtcategorycode"></asp:RequiredFieldValidator>
        </td>
	</tr>
    <tr class="whitebg">
		<td align="right" class="tdtext">Designation Name :</td>
		<td class="tdtext"><asp:TextBox ID="txtcategorydesc" runat="server" Width="300px" 
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                ErrorMessage="Enter Desig Name" SetFocusOnError="True" 
	...
	<tr>
		...
		<tr class="">
		    ...
		    <asp:DropDownList ID="drpreportsearch" runat="server" CssClass="control"> 
		         <asp:ListItem Value="desigcode">Designation Code</asp:ListItem>
                 <asp:ListItem Value="designame">Designation Name</asp:ListItem>
            </asp:DropDownList></td>
		    <td class="tdtext">
	...
	<tr class="">
	    ...
	    <table align="center" cellpadding="0" cellspacing="0" width="100%" style="background-color:white;">
	        <tr class="">
	            <td>
                    <asp:GridView ID="grdreportcategory" runat="server"  DataKeyNames="desigid" 
                    CssClass="mGrid"
                    GridLines="None"
                    ...
                    AutoGenerateColumns="false" Width="100%" EmptyDataText="No Data Found !">
                     <Columns>
                          ...
                          <ItemTemplate><%#Container.DataItemIndex + 1%></ItemTemplate>
                            ...
                            <asp:BoundField HeaderText="Designation Name" HeaderStyle-HorizontalAlign="Center" DataField="desigcode" SortExpression="desigcode" ReadOnly="true" />
                            <asp:BoundField HeaderText="Designation Code" HeaderStyle-HorizontalAlign="Center" DataField="designame" SortExpression="designame" />
                         ...
                         <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" ItemStyle-Width="10%">
                          ...
                          <ItemTemplate>
                          <asp:ImageButton ID="imgdelete" CommandName="Deleterow" CommandArgument='<%# Eval("desigid")%>' runat="server" ImageUrl="~/Images/Delete.png" OnClientClick="javascript:return confirm('Are you Sure want to Delete This Item?');"  ></asp:ImageButton>
                          </ItemTemplate>
                             </asp:TemplateField>
                        </Columns>
                    </asp:GridView>	   
